...
public interface BookDAO extends DAO<Book, ObjectId> {
	...
	/**
	 * Updates an existing item. If the item has been modified between the read
	 * and write this should throw a {@link ConcurrentModificationException}
	 * 
	 * @param item
	...
	/**
	 * Given map of queries return all matching items. The query is a
